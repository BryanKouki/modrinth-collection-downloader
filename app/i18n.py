...
_PT: Dict[str, str] = {
    ...
    "radio_save_mrpack": ".mrpack (Modpack do Modrinth)",
    "hint_mrpack": "Um .mrpack não contém os arquivos em si, só as referências para baixá-los depois num launcher como Prism/MultiMC. Só funciona com os loaders fabric, forge, neoforge ou quilt — plugins e datapacks ficam de fora.",
    ...
    "msg_error_mrpack_unsupported_loader": ".mrpack só é compatível com os loaders fabric, forge, neoforge ou quilt. Escolha um deles, ou selecione outro formato pra salvar.",
...
_EN: Dict[str, str] = {
    ...
    "radio_save_mrpack": ".mrpack (Modrinth Modpack)",
    "hint_mrpack": "A .mrpack doesn't contain the files themselves, just references for a launcher like Prism/MultiMC to download them later. Only works with the fabric, forge, neoforge or quilt loaders — plugins and datapacks are left out.",
    ...
    "msg_error_mrpack_unsupported_loader": ".mrpack only supports the fabric, forge, neoforge or quilt loaders. Pick one of those, or choose a different save format.",
